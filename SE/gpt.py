...
def call_gpt_audio(audio_path: str, prompt: str, voice: str, audio_format: str, max_tokens: int) -> str:
    ...
    return resp.choices[0].message.audio.transcript
...
def parse_args():
    ...
    parser.add_argument("--model-name", default="gpt")
